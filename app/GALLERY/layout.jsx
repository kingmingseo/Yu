...
export default function GalleryLayout({ children }) {
  const pathname = useParams().category;

  return (
    <div>
      <aside className="sm:hidden text-sm grid grid-cols-4 grid-rows-2 gap-1 top-16 left-0 w-full place-items-center mb-5">
        <Link
          className={pathname === "LOOKBOOK" ? "underline" : "no-underline"}
          href="/GALLERY/LOOKBOOK"
        >
          LOOKBOOK
        </Link>
        <Link
          className={pathname === "POLAROID" ? "underline" : "no-underline"}
          href="/GALLERY/POLAROID"
        >
          POLAROID
        </Link>
        <Link
          className={pathname === "BEAUTY" ? "underline" : "no-underline"}
          href="/GALLERY/BEAUTY"
        >
          BEAUTY
        </Link>
        <Link
          className={pathname === "MEDIA" ? "underline" : "no-underline"}
          href="/GALLERY/MEDIA"
        >
          MEDIA
        </Link>
        <Link
          className={pathname === "MV" ? "underline" : "no-underline"}
          href="/GALLERY/MV"
        >
          M/V
        </Link>
        <Link
          className={pathname === "VIDEO" ? "underline" : "no-underline"}
          href="/GALLERY/VIDEO"
        >
          VIDEO
        </Link>
        <Link
          className={pathname === "MAGAZINE" ? "underline" : "no-underline"}
          href="/GALLERY/MAGAZINE"
        >
          MAGAZINE
        </Link>
        <Link
          className={pathname === "PROFILE" ? "underline" : "no-underline"}
